...
void Pipeline::createGraphicsPipeline(const std::string &vertFilepath, const std::string &fragFilepath, const PipelineConfigInfo &configInfo) {
    assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot create graphics pipeline:: no pipelineLayout provided in configIngo");
    assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot create graphics pipeline:: no renderPass provided in configIngo");
...
Pipeline::Pipeline(Device& device, const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo &configInfo, const std::string& compFilepath, VkPipelineLayout computeLayout) : _device{ device } {
    createGraphicsPipeline(vertFilepath, fragFilepath, configInfo);
    createComputePipeline(compFilepath, computeLayout);
}
